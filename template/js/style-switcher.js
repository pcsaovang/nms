...
StyleSwitcher.prototype.build = function () {
    ...
    $('body').css({
        'background-image': 'url(' + imgPath + 'public/template/backend/img/pattern/' + $this.storageManager.getBgImage() + '.png)',
    ...
    if (itm.ci) {
        ...
        var colorSelStyle = $('<link/>')
            .attr({
                'rel': 'stylesheet',
                'href': imgPath + 'public/template/backend/lib/colorpicker/css/colorpicker.css'
            }),
            colorSelHackStyle = $('<link/>').attr({
                'rel': 'stylesheet',
                'href': imgPath + 'public/template/backend/css/colorpicker_hack.css'
            });
        ...
        var url = imgPath + 'public/template/backend/lib/colorpicker/js/bootstrap-colorpicker.js';
    ...
    $.each(patternImages, function (i) {
        var listElement = $('<li/>').append($('<a/>').css({
                'background': 'url(' + imgPath + 'public/template/backend/img/pattern/' + patternImages[i].image + '.png) repeat'
            }).attr({
                'href': '#',
    ...
    patternList.find('a').on(Metis.buttonPressedEvent, function (e) {
        e.preventDefault();
        $('body').css({
            'background-image': 'url(' + imgPath + 'public/template/backend/img/pattern/' + $(this).data('patternImage') + '.png)',
            'background-repeat': ' repeat'
        });
