		...
		<div class="row">
			...
			<article class="col-md-10 maincontent">
				<header class="page-header">
					<h4 class="page-title">Tìm kiếm</h1>
				</header>
				<div class="col-lg-12">
				<form action="https://www.google.com/search" method="get" target="_bank">
				<div class="input-group">
					<input type="text" name="q" class="form-control input-lg" autocomplete="off" />
					<span class="input-group-btn">
						<button class="btn btn-primary btn-block btn-lg" type="submit">Go!</button>
					</span>
				</div>
				</form>
				</div>
